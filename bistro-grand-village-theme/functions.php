...
define('BGV_THEME_VERSION', '1.0.0');
...
function bgv_register_acf_fields() {
  ...
  acf_add_local_field_group(array(
    ...
    'title' => '黒板メニュー画像',
    'fields' => array(
      array('key' => 'field_bgv_blackboard_image_1', 'label' => '黒板メニュー画像1', 'name' => 'blackboard_image_1', 'type' => 'image', 'return_format' => 'array', 'preview_size' => 'medium'),
      array('key' => 'field_bgv_blackboard_image_2', 'label' => '黒板メニュー画像2', 'name' => 'blackboard_image_2', 'type' => 'image', 'return_format' => 'array', 'preview_size' => 'medium'),
    ),
  ...
  $menu_fields = array(
    array(
      ...
      'sub_fields' => array(
        array('key' => 'field_bgv_section_title', 'label' => 'セクション名', 'name' => 'section_title', 'type' => 'text'),
        array('key' => 'field_bgv_section_subtitle', 'label' => '英字サブタイトル', 'name' => 'section_subtitle', 'type' => 'text'),
        array(
          'key' => 'field_bgv_menu_items',
          'label' => 'メニュー項目',
          'name' => 'menu_items',
          'type' => 'repeater',
          'layout' => 'row',
          ...
          'sub_fields' => array(
            array('key' => 'field_bgv_menu_name', 'label' => 'メニュー名', 'name' => 'menu_name', 'type' => 'textarea', 'rows' => 3, 'new_lines' => 'br'),
            array('key' => 'field_bgv_menu_price', 'label' => '料金', 'name' => 'menu_price', 'type' => 'text'),
            array('key' => 'field_bgv_menu_image', 'label' => '画像', 'name' => 'menu_image', 'type' => 'image', 'return_format' => 'array', 'preview_size' => 'thumbnail'),
            array('key' => 'field_bgv_menu_url', 'label' => 'リンク先URL', 'name' => 'menu_url', 'type' => 'url'),
          ),
        ),
      ),
    ),
  ...
  acf_add_local_field_group(array(
    ...
    'fields' => $menu_fields,
    'location' => array(
      array(array('param' => 'page_template', 'operator' => '==', 'value' => 'page-lunch.php')),
      array(array('param' => 'page_template', 'operator' => '==', 'value' => 'page-kids.php')),
      array(array('param' => 'page_template', 'operator' => '==', 'value' => 'page-drink.php')),
      array(array('param' => 'page_template', 'operator' => '==', 'value' => 'page-wine.php')),
    ),
  ));
  ...
  acf_add_local_field_group(array(
    ...
    'title' => '営業時間＆アクセス',
    'fields' => array(
      array('key' => 'field_bgv_business_hours', 'label' => '営業時間', 'name' => 'business_hours', 'type' => 'textarea', 'rows' => 3, 'new_lines' => 'br'),
      array('key' => 'field_bgv_lunch_hours', 'label' => 'ランチ営業時間', 'name' => 'lunch_hours', 'type' => 'text'),
      array('key' => 'field_bgv_dinner_hours', 'label' => 'ディナー営業時間', 'name' => 'dinner_hours', 'type' => 'text'),
      ...
      array('key' => 'field_bgv_google_map', 'label' => 'Googleマップ埋め込みコード', 'name' => 'google_map_embed', 'type' => 'textarea', 'rows' => 5),
    ),
    'location' => array(
      array(array('param' => 'page_template', 'operator' => '==', 'value' => 'page-access.php')),
    ),
  ));
}
...
function bgv_after_switch_theme() {
  ...
  bgv_create_page_if_missing('ディナーメニュー', 'food', '');
  ...
  bgv_create_page_if_missing('内観＆外観', 'interior-exterior', '');
  bgv_create_page_if_missing('ギャラリー', 'gallery', '');
