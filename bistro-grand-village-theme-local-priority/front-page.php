...
<section id="top_cover">
  <div class="hero-shell">
    <div class="flexslider">
      <ul class="slides">
        <li><img src="<?php echo bgv_asset_uri('assets/images/assets/slide1.jpg'); ?>" alt="ビストロ グランヴィラージュ" /></li>
        <li><img src="<?php echo bgv_asset_uri('assets/images/assets/slide2.jpg'); ?>" alt="料理写真" /></li>
        <li><img src="<?php echo bgv_asset_uri('assets/images/assets/slide4.jpg'); ?>" alt="料理写真" /></li>
        <li><img src="<?php echo bgv_asset_uri('assets/images/assets/slide5.jpg'); ?>" alt="料理写真" /></li>
        <li><img src="<?php echo bgv_asset_uri('assets/images/assets/slide6.jpg'); ?>" alt="料理写真" /></li>
      </ul>
    </div>
...
<section id="home_profile">
  <div class="container">
    ...
    <div class="row lazy">
      <div class="span3">
        <img src="<?php echo bgv_asset_uri('assets/images/assets/chef2.jpg'); ?>" class="prof_photo" alt="大村 航介" loading="lazy" />
      </div>
      <div class="span9">
