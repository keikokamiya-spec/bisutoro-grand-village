...
function bgv_enqueue_assets() {
  wp_enqueue_style('bgv-google-fonts', 'https://fonts.googleapis.com/css2?family=Cormorant+Garamond:ital,wght@0,300;0,400;0,600;1,300;1,400&family=Shippori+Mincho:wght@400;500;600;700&family=Noto+Sans+JP:wght@300;400;500&display=swap', array(), null);
  wp_enqueue_style('bgv-style', bgv_asset_uri('assets/css/style.css'), array('bgv-google-fonts'), BGV_THEME_VERSION);
