...
<section id="home_access">
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="span7">
        <?php if ($store_name) : ?><?php echo esc_html($store_name); ?><br /><?php endif; ?>
        ...
        <br />
        <?php if ($phone_number) : ?>
          <i class="fa fa-phone-square" aria-hidden="true"></i> <a href="tel:<?php echo esc_attr($tel_href); ?>"><?php echo esc_html($phone_number); ?></a><br />
        <?php endif; ?>
        <?php if ($map_link_url) : ?>
          <a href="<?php echo esc_url($map_link_url); ?>" target="_blank" rel="noopener">Googleマップで見る</a><br />
        <?php endif; ?>
